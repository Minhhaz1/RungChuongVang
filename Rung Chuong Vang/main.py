...
content3=content('What is 5*3 ?','A: 15','B: 20','C: 25','D: 30','B')
content4=content('What is 5*2 ?','A: 15','B: 20','C: 25','D: 30','B')
content5=content('2 KMnO4 + 10 FeSO4 + 8 H2SO4 ->  ?','A: → 2 MnSO4 + 5 Fe2(SO4)3 + K2SO4 + 8 H2O','B: 20','C: 25','D: 30','B')
...
name_header=lagre_font.render('Ring the golden bell !',True,('#000080'))
